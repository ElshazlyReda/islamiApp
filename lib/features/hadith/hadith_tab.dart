...
import 'package:islami/features/hadith/widgets/hadith_item_card.dart';
...
class HadithTab extends StatelessWidget {
  ...
  List<SuraDetails> items = [
    SuraDetails(
        id: 1, nameAR: "الفَاتِحَة", nameEN: "al-Fatihah", verseCount: 7),
    SuraDetails(
        id: 2, nameAR: "البَقَرَة", nameEN: "al-Baqarah", verseCount: 286),
    SuraDetails(
        id: 3, nameAR: "آل عِمرَان", nameEN: "Aal-e-Imran", verseCount: 200),
    SuraDetails(id: 4, nameAR: "النِّسَاء", nameEN: "an-Nisa", verseCount: 176),
    SuraDetails(
        id: 5, nameAR: "المَائدة", nameEN: "al-Maidah", verseCount: 120),
    ...
    SuraDetails(
        id: 17, nameAR: "الإسْرَاء", nameEN: "al-Isra", verseCount: 111),
    ...
    SuraDetails(
        id: 21, nameAR: "الأنبيَاء", nameEN: "al-Anbiya", verseCount: 112),
    SuraDetails(id: 22, nameAR: "الحَج", nameEN: "al-Hajj", verseCount: 78),
    SuraDetails(
        id: 23, nameAR: "المُؤمنون", nameEN: "al-Mu'minun", verseCount: 118),
    SuraDetails(id: 24, nameAR: "النُّور", nameEN: "an-Nur", verseCount: 64),
    SuraDetails(
        id: 25, nameAR: "الفُرْقان", nameEN: "al-Furqan", verseCount: 77),
    SuraDetails(
        id: 26, nameAR: "الشُّعَرَاء", nameEN: "ash-Shu'ara", verseCount: 227),
    ...
    SuraDetails(
        id: 37, nameAR: "الصَّافات", nameEN: "as-Saffat", verseCount: 182),
    ...
    SuraDetails(
        id: 41, nameAR: "فُصِّلَتْ", nameEN: "Fussilat", verseCount: 54),
    SuraDetails(
        id: 42, nameAR: "الشُّورَى", nameEN: "ash-Shura", verseCount: 53),
    SuraDetails(
        id: 43, nameAR: "الزُّخْرُف", nameEN: "az-Zukhruf", verseCount: 89),
    SuraDetails(
        id: 44, nameAR: "الدُّخان", nameEN: "ad-Dukhan", verseCount: 59),
    SuraDetails(
        id: 45, nameAR: "الجاثِية", nameEN: "al-Jathiyah", verseCount: 37),
    ...
    SuraDetails(
        id: 49, nameAR: "الحُجُرات", nameEN: "al-Hujurat", verseCount: 18),
    SuraDetails(id: 50, nameAR: "ق", nameEN: "Qaf", verseCount: 45),
    SuraDetails(
        id: 51, nameAR: "الذَّاريَات", nameEN: "adh-Dhariyat", verseCount: 60),
    ...
    SuraDetails(
        id: 55, nameAR: "الرَّحْمَٰن", nameEN: "ar-Rahman", verseCount: 78),
    SuraDetails(
        id: 56, nameAR: "الوَاقِعَة", nameEN: "al-Waqi'ah", verseCount: 96),
    SuraDetails(id: 57, nameAR: "الحَدِيد", nameEN: "al-Hadid", verseCount: 29),
    SuraDetails(
        id: 58, nameAR: "المُجَادِلَة", nameEN: "al-Mujadilah", verseCount: 22),
    ...
    SuraDetails(
        id: 62, nameAR: "الجُمُعَة", nameEN: "al-Jumu'ah", verseCount: 11),
    SuraDetails(id: 63,
        nameAR: "المُنَافِقُون",
        nameEN: "al-Munafiqun",
        verseCount: 11),
    SuraDetails(
        id: 64, nameAR: "التَّغَابُن", nameEN: "at-Taghabun", verseCount: 18),
    SuraDetails(
        id: 65, nameAR: "الطَّلَاق", nameEN: "at-Talaq", verseCount: 12),
    SuraDetails(
        id: 66, nameAR: "التَّحْرِيم", nameEN: "at-Tahrim", verseCount: 12),
    ...
    SuraDetails(
        id: 69, nameAR: "الحَاقَّة", nameEN: "al-Haqqah", verseCount: 52),
    SuraDetails(
        id: 70, nameAR: "المَعَارِج", nameEN: "al-Ma'arij", verseCount: 44),
    SuraDetails(id: 71, nameAR: "نُوح", nameEN: "Nuh", verseCount: 28),
    SuraDetails(id: 72, nameAR: "الجِنّ", nameEN: "al-Jinn", verseCount: 28),
    SuraDetails(
        id: 73, nameAR: "المُزَّمِّل", nameEN: "al-Muzzammil", verseCount: 20),
    SuraDetails(
        id: 74, nameAR: "المُدَّثِّر", nameEN: "al-Muddathir", verseCount: 56),
    SuraDetails(
        id: 75, nameAR: "القِيَامَة", nameEN: "al-Qiyamah", verseCount: 40),
    SuraDetails(id: 76, nameAR: "الإنسَان", nameEN: "al-Insan", verseCount: 31),
    SuraDetails(
        id: 77, nameAR: "المُرْسَلَات", nameEN: "al-Mursalat", verseCount: 50),
    SuraDetails(id: 78, nameAR: "النَّبَأ", nameEN: "an-Naba", verseCount: 40),
    SuraDetails(
        id: 79, nameAR: "النَّازِعَات", nameEN: "an-Nazi'at", verseCount: 46),
    SuraDetails(id: 80, nameAR: "عَبَسَ", nameEN: "Abasa", verseCount: 42),
    SuraDetails(
        id: 81, nameAR: "التَّكْوِير", nameEN: "at-Takwir", verseCount: 29),
    SuraDetails(
        id: 82, nameAR: "الانفِطَار", nameEN: "al-Infitar", verseCount: 19),
    SuraDetails(id: 83,
        nameAR: "المُطَفِّفِين",
        nameEN: "al-Mutaffifin",
        verseCount: 36),
    SuraDetails(
        id: 84, nameAR: "الانشِقَاق", nameEN: "al-Inshiqaq", verseCount: 25),
    SuraDetails(id: 85, nameAR: "البُرُوج", nameEN: "al-Buruj", verseCount: 22),
    SuraDetails(
        id: 86, nameAR: "الطَّارِق", nameEN: "at-Tariq", verseCount: 17),
    SuraDetails(id: 87, nameAR: "الأعلى", nameEN: "al-A'la", verseCount: 19),
    SuraDetails(
        id: 88, nameAR: "الغَاشِيَة", nameEN: "al-Ghashiyah", verseCount: 26),
    ...
    SuraDetails(
        id: 91, nameAR: "الشَّمْس", nameEN: "ash-Shams", verseCount: 15),
    ...
    SuraDetails(
        id: 98, nameAR: "البَيِّنَة", nameEN: "al-Bayyinah", verseCount: 8),
    SuraDetails(
        id: 99, nameAR: "الزَّلْزَلَة", nameEN: "az-Zalzalah", verseCount: 8),
    SuraDetails(
        id: 100, nameAR: "العَادِيَات", nameEN: "al-Adiyat", verseCount: 11),
    SuraDetails(
        id: 101, nameAR: "القَارِعَة", nameEN: "al-Qari'ah", verseCount: 11),
    SuraDetails(
        id: 102, nameAR: "التَّكَاثُر", nameEN: "at-Takathur", verseCount: 8),
    SuraDetails(id: 103, nameAR: "العَصْر", nameEN: "al-Asr", verseCount: 3),
    SuraDetails(
        id: 104, nameAR: "الهُمَزَة", nameEN: "al-Humazah", verseCount: 9),
    SuraDetails(id: 105, nameAR: "الفِيل", nameEN: "al-Fil", verseCount: 5),
    SuraDetails(id: 106, nameAR: "قُرَيْش", nameEN: "Quraysh", verseCount: 4),
    SuraDetails(
        id: 107, nameAR: "المَاعُون", nameEN: "al-Ma'un", verseCount: 7),
    SuraDetails(
        id: 108, nameAR: "الكَوْثَر", nameEN: "al-Kawthar", verseCount: 3),
    SuraDetails(
        id: 109, nameAR: "الكَافِرُون", nameEN: "al-Kafirun", verseCount: 6),
    ...
    SuraDetails(
        id: 112, nameAR: "الإخْلَاص", nameEN: "al-Ikhlas", verseCount: 4),
  ...
  Widget build(BuildContext context) {
    ...
    double logoHeight = size.height*0.30;
    double sliderHeight = size.height - logoHeight;
    return Container(
      ...
      child: Column(
        ...
        children: [
          SizedBox(
            height: size.height * 0.2, // Reduced height of app logo container
            child: Center(
              child: Image(
                image: AssetImage(AppAssets.appLogo),
                height: size.height * 0.30, // Smaller app logo
                width: size.height * 0.30, // Maintaining square aspect ratio
              ),
            ),
          ),
          Expanded(
            child: CarouselSlider(
                items: items.map(
                      (e) {
                  return ClipRRect( borderRadius: BorderRadius.circular(20),child: HadithItemCard());
                },).toList(),
